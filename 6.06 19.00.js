...
/* Reload page when resized so that plotly graph resizes*/
window.onresize = function () {
    location.reload();
}

/*When scrolling reaches a point, make element id navbar work as element id stuck*/
window.onscroll = function () {
    var sticky = document.getElementById('navbar');
    if (document.body.scrollTop + document.documentElement.scrollTop > (window.innerWidth / 100 * 16))
        sticky.className = "stuck";
    else sticky.className = "navbar";
};
